...
type ShipperConfig struct {
	...
	MaxBufferSize          int     `long:"max-buffer-size" description:"Maximum number of messages to keep in the internal buffer" default:"1048576"`
	MaxBatchSize           int     `long:"max-batch-size" description:"Number of messages to send to the consumer in a single web socket call. This should be smaller than the buffer size." default:"65536"`
